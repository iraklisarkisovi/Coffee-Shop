...
const CapuccinoList = ({ Status, Remove, id, name }) => {
  ...
  const [selectedIngredients, setSelectedIngredients] = useState(['Sugar', 'Milk', 'Water', 'Coffee']);
  ...
  return (
    <div>
      <div className='coffeeRedact'>
        <div className={selectedIngredients.length > 0 ? 'filledCapuccino-cup' : 'empty-cup'}></div>
